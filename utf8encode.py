...
def change_encoding(filename):
    ...
    if source_encoding != 'utf-8' and source_encoding != 'ascii' and source_encoding != 'windows-1251' and source_encoding != 'windows-1252':
        source_encoding = 'utf-8'
    if source_encoding is None or source_encoding == TARGET_ENCODING:
        return False
    ...
    with open(filename, 'w', encoding=TARGET_ENCODING, newline='\r\n') as f:
        f.write(content)
